...
export default function AdminCMS() {
  ...
  const saveMutation = useMutation({
    ...
    onSuccess: () => {
      qc.invalidateQueries(["admin-cms"]);
    ...
    <>
      ...
      <div className="space-y-5">
        <div>
          ...
          <p className="text-sm text-gray-400">Manage static content pages</p>
        </div>
              ...
              return (
                ...
                >
                  <div className="flex items-start justify-between mb-3">
                    ...
                    <span
                      className={`badge text-[10px] ${existing?.isActive ? "bg-green-100 text-green-700" : "bg-gray-100 text-gray-500"}`}
                    >
